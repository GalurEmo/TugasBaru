            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="{{asset('template')}}/dist/img/download1111.jpg" class="user-image" alt="User Image">
                  <span class="hidden-xs">Galur Pangestu</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('template')}}/dist/img/download1111.jpg" class="img-circle" alt="User Image">
                    <p>
                      Galur Pangestu - Web Developer
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="{{asset('template')}}/dist/download1111.jpg" class="img-circle" alt="User Image">
            </div>
